...
class ADFLOW(AeroSolver):
    ...
    def _getDefaultOptions():
        defOpts = {
            ...
            "SABCM_PG": [bool, False],
            "SABCM_PG_map": [int, 1],
            "SABCM_PG_sensor": [int, 1],
            "SABCM_PG_sdir": [int, 2],
            "SABCM_PG_F": [int, 1],
            "SABCM_PG_K": [float, 0.05064],
            "SABCM_PG_coef": [float, 7.57e-3],
            "SABCM_PG_off": [float, 0.0128],
            "SABCM_PG_gain": [float, 1.0],
            "SABCM_PG_lamMax": [float, 0.1],
            "SABCM_PG_p": [float, 300.0],
    ...
    def _getOptionMap(self):
        ...
        optionMap = {
            ...
            "sabcm_pg": ["physics", "sabcm_pg"],
            "sabcm_pg_map": ["physics", "sabcm_pg_map"],
            "sabcm_pg_sensor": ["physics", "sabcm_pg_sensor"],
            "sabcm_pg_sdir": ["physics", "sabcm_pg_sdir"],
            "sabcm_pg_f": ["physics", "sabcm_pg_f"],
            "sabcm_pg_k": ["physics", "sabcm_pg_k"],
            "sabcm_pg_coef": ["physics", "sabcm_pg_coef"],
            "sabcm_pg_off": ["physics", "sabcm_pg_off"],
            "sabcm_pg_gain": ["physics", "sabcm_pg_gain"],
            "sabcm_pg_lammax": ["physics", "sabcm_pg_lammax"],
            "sabcm_pg_p": ["physics", "sabcm_pg_p"],
