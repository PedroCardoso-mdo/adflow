...
class ADFLOW(AeroSolver):
    ...
    def _getDefaultOptions():
        defOpts = {
            ...
            "SAcrot": [float, 2.0],
            "useSABCM": [bool, False],
            "SABCMSmooth": [bool, True],
            "SABCMChi1": [float, 0.002],
            "SABCMChi2": [float, 0.02],
            "SABCMRho": [float, 50.0],
            "SABCMTanhCenter": [float, 0.5],
            "SABCMTanhWidth": [float, 0.08],
            # Common Parameters
            "nCycles": [int, 2000],
            "timeLimit": [float, -1.0],
    ...
    def _getOptionMap(self):
        ...
        optionMap = {
            ...
            "usesabcm": ["physics", "usesabcm"],
            "sabcmsmooth": ["physics", "sabcmsmooth"],
            "sabcmchi1": ["physics", "sabcmchi1"],
            "sabcmchi2": ["physics", "sabcmchi2"],
            "sabcmrho": ["physics", "sabcmrho"],
            "sabcmtanhcenter": ["physics", "sabcmtanhcenter"],
            "sabcmtanhwidth": ["physics", "sabcmtanhwidth"],
            # Common Parameters
