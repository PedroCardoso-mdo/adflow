...
| 2026-07-21 | Three-stage low-level adjoint verification (SA-GR, nw=8) — Stages 1&3 PASS, Stage 2 FAILS on reThetat → fixed next day, see 2026-07-22 row | [2026-07-21-three-stage-adjoint-verification-sagr.md](2026-07-21-three-stage-adjoint-verification-sagr.md) |
...
Note: no entries after 2026-07-24 — later work (crossflow default flip,
λθ-clamp test+revert, matrix-dissipation limiters, S809/NLF campaign, AR5
NK-engagement findings) is recorded in
`../VERIFICATION/paper-validation-campaign.md` and
`../convergence-strategy.md` instead.
