...
audits (2026-07-06/07). Lives in `audits/` because that's where the
underlying investigation happened — this file is the durable takeaway, the
audits themselves (`../audits/`) are the raw trail. The old `findings/`
