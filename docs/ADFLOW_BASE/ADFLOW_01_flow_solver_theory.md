...
> see `docs/CORE_BASE/CORE_02_convergence_strategy.md`, commit ef9fc10d); "decoupled beats
...
> below as paper record, checked against `docs/CORE_BASE/CORE_02_convergence_strategy.md` before
> use on SA-GR.
