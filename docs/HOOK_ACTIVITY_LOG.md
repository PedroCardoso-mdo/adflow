...
- **2026-07-31 13:40:38** — auto-pip: reinstalled adflow (real build) into mach env after `source /home/mdo/packages_v2/mach/bin/activate && export PETSC_ARCH=real-debug && make && pip instal` (site-packages now matches ./adflow)
- **2026-07-31 14:34:25** — auto-pip: reinstalled adflow (real build) into mach env after `source /home/mdo/packages_v2/mach/bin/activate && export PETSC_ARCH=real-debug && make && pip instal` (site-packages now matches ./adflow)
- **2026-07-31 15:00:34** — auto-pip: reinstalled adflow (real build) into mach env after `ssh -o BatchMode=yes pedrocardoso@login.deucalion.macc.fccn.pt 'cat > /projects/F202500002HPCVLABIST` (site-packages now matches ./adflow)
- **2026-08-02 22:50:10** — auto-pip: reinstalled adflow (real build) into mach env after `source /home/mdo/packages_v2/mach/bin/activate && export PETSC_ARCH=real-debug && make 2>&1 | tail -` (site-packages now matches ./adflow)
- **2026-08-02 23:04:16** — auto-pip: reinstalled adflow (real build) into mach env after `timeout 590 ssh pedrocardoso@login.deucalion.macc.fccn.pt 'set -e; BASE=/projects/F202500002HPCVLABI` (site-packages now matches ./adflow)
