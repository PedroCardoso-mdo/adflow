...
!   gradient     of useful results: flam
!   with respect to varying inputs: lam
  subroutine bcmflambdamenter_fast_b(tu, lam, lamd, flamd)
!
...
! cap 3.0 (never active here)
    ...
    tmpd0 = fpgd
    fpgd = 0.0_8
    call smoothminmax_fast_b(fpg, fpgd, cpg2lim, mclip, tmpd0)
    ud = -(cpg2*fpgd)
    ...
    tmpd = lamcd
    lamcd = 0.0_8
    call smoothminmax_fast_b(lamc, lamcd, lamposclip, mclip, tmpd)
    call smoothminmax_fast_b(lam, lamd, lamsepclip, pclip, lamcd)
    lamd = lamd + 35.0_realtype*exp(-(35.0_realtype*lam))*exp(-(tu/&
&     0.5_realtype))*0.275_realtype*f1vald
  end subroutine bcmflambdamenter_fast_b
