...
!                                                                      |
! ----------------------------------------------------------------------
  subroutine rethetatcorrelation_fast_b(tu, lambdatheta, lambdathetad, &
&   rethetatd)
!
...
! a negative target re_theta_t without this.
    ...
    tmpd = rethetatd
    rethetatd = 0.0_8
    call smoothminmax_fast_b(rethetat, rethetatd, arg10, arg1d0, &
&                      rsagrpmax, tmpd)
...
&       -0.671_realtype)*rethetatd
    ...
    f2vald = 0.0_8
    call smoothminmax_fast_b(f2val, f2vald, f3val, f3vald, rsagrpmin, &
&                      flambdad)
    tempd = -(exp(-((tu_safe/1.5_realtype)**1.5_realtype))*f3vald)
    f1vald = 0.0_8
    call smoothminmax_fast_b(f1val, f1vald, arg1, arg1d, rsagrpmax, &
&                      f2vald)
...
&     *tempd
  end subroutine rethetatcorrelation_fast_b
...
!   with respect to varying inputs: rethetatilde
  subroutine rethetaccorrelation_fast_b(rethetatilde, rethetatilded, &
&   rethetacd)
!
...
&     rethetacd
  end subroutine rethetaccorrelation_fast_b
