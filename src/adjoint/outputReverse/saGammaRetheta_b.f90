...
! Stub reverse-mode AD of Source (saGammaRetheta)
! Regenerate with: make -f Makefile_tapenade ad_reverse
  subroutine source_b()
    implicit none
    ! Placeholder: regenerate with Tapenade ad_reverse
  end subroutine source_b

! Stub reverse-mode AD of Viscous (saGammaRetheta)
  subroutine viscous_b()
    implicit none
    ! Placeholder: regenerate with Tapenade ad_reverse
  end subroutine viscous_b

! Stub reverse-mode AD of ResScale (saGammaRetheta)
