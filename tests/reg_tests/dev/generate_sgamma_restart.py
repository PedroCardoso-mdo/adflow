#!/usr/bin/env python
"""Generate the SA-noft2-Gamma (SA-sgamma) restart CGNS for the derivative
...
from reg_sgamma import sagrBaseOptions
...
def main():
    ...
    parser.add_argument(
        "--output",
        default=os.path.join(baseDir, "../../../input_files/mdo_tutorial_sgamma_dp.cgns"),
    ...
    parser.add_argument(
        ...
        "(e.g. the existing mdo_tutorial_sgamma_dp.cgns, to continue "
    ...
    if args.restartfile is not None:
        ...
        # the current mdo_tutorial_sgamma_dp.cgns)
