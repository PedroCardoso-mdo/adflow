...
test_params = [
    {
        ...
        "ref_file": "jacvecbwd_sgamma_tut_wing.json",
...
class TestJacVecBWDFastSGAMMA(reg_test_classes.RegTest):
    """
    ...
    mode (_b) for the SA-noft2-Gamma model. Mirrors TestJacVecBWDFast
...
@parameterized_class(test_params)
class TestDotProductsSGAMMA(reg_test_classes.RegTest):
    """
    Transpose (dot-product) tests between the forward (_d) and reverse (_b)
    modes for the SA-noft2-Gamma model: the full set from
