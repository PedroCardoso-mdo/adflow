...
echo "=== adjoint real $(date)"; BCM_VARIANTS=smooth,hard real test_adjoint_bcm.py > logs/regtests_adjoint_$J.log 2>&1; summ logs/regtests_adjoint_$J.log
echo "=== adjoint cs $(date)";   BCM_VARIANTS=smooth,hard cplx test_adjoint_bcm.py -m "cmplx_test_*" > logs/regtests_adjointcs_$J.log 2>&1; summ logs/regtests_adjointcs_$J.log
